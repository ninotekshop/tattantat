...
data class ProductItemPayload(val id: String, val title: String, val price: String, val location: String, val postedAt: String, val sellerId: String = "", val sellerName: String, val imageUrl: String, val description: String? = null, val condition: String? = null, val categoryId: Long? = null, val status: String = "ACTIVE", val priceMode: String = "FIXED", val listingId: String? = null)
